          ...
          <form className="form-inputs">
           ...
           {userCookieData ? <input type="text"  value={userData.allergies} required/> : <input type="text" placeholder="Alergies" onChange={(e) => setFormData({...formData, allergies: e.target.value})} value={formData.allergies} required/>} 
            <ReactDatePicker
              ...
              minDate={new Date()}
              includeTimes={[1675883200000, 1675884100000, 1675885000000, 1675885900000, 1675886800000, 1675887700000, 1675888600000, 1675889500000, 1675890400000, 1675908400000, 1675908400000, 1675909300000, 1675910200000, 1675911100000, 1675912000000, 1675912900000, 1675913800000, 1675914700000, 1675915600000]}
